...
@greeting_app.get("/greet", response_model=GreetingResponse, summary="Greet via query parameter")
...
@greeting_app.post("/greet", response_model=GreetingResponse, summary="Greet via JSON payload")
